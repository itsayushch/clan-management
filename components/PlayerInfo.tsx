            ...
            <Grid grow>
                <Grid.Col span={10}>
                    <Group wrap="nowrap">
                        ...
                        <div>
                            ...
                            {/* @ts-ignore */}
                            <Badge mt={12} color={strikeColorScheme[player.totalStrikes]} variant="light" size="md" radius="sm">
                                {/* @ts-ignore */}
                                {player.totalStrikes} Strike{player.strikes > 1 ? 's' : ''}
                            </Badge>
                        </div>
                    </Group>
                ...
                <Grid.Col span={2}>
                    <Group px={'lg'} preventGrowOverflow>
                        {user ? (
                            <Button fullWidth color='teal' leftSection={<IconPencil size={20} />} onClick={open1} display={user ? 'block' : 'none'}>Edit Strikes</Button>
